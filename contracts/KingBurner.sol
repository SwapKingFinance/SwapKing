...
contract KingBurner
{
    ...
    function harvestAndBurn() public {
        ...
        // King has no burn function and cannot send to 0x0, so we send it to the 0xdead000... address
        king.transfer(0xdEad000000000000000000000000000000000000, king.balanceOf(address(this)));
    }
}
